...
on_model_directory_dict = {'K562': '../models/on-target/k562/on-target_RNN-weights_for-K562',
...
off_model_path_dict = {'K562': '../models/off-target/off-target-best-model.model'}
